...
} from '@/features/sales/quote-line-items/types';

export const DEFAULT_LINE_ITEM_FORM_VALUES: LineItemFormValues = {
  name: '',
  description: '',
  quantity: '1',
  unit: '',
...
export function lineItemToFormValues(item: QuoteLineItemListItem): LineItemFormValues {
  return {
    name: item.name,
...
export function areLineItemFormValuesEqual(
  left: LineItemFormValues,
  right: LineItemFormValues,
): boolean {
  return (
...
export function validateLineItemForm(values: LineItemFormValues): LineItemFormErrors {
...
export function calculateFormLineTotal(values: LineItemFormValues): number {
...
export function toCreateLineItemPayload(values: LineItemFormValues): CreateQuoteLineItemPayload {
  return {
...
export function toUpdateLineItemPayload(values: LineItemFormValues): UpdateQuoteLineItemPayload {
  return toCreateLineItemPayload(values);
}
