            ...
            {lineItems.map((item, index) => (
              <TableRow key={item.id}>
                ...
                <TableCell className="text-right">
                  {formatQuoteAmount(item.unitPrice, currency)}
                </TableCell>
                <TableCell className="hidden sm:table-cell text-right">
                  {formatQuoteAmount(item.discount, currency)}
                </TableCell>
                <TableCell className="hidden sm:table-cell text-right">
                  {formatQuoteAmount(item.tax, currency)}
                </TableCell>
                <TableCell className="text-right font-medium">
                  {formatQuoteAmount(item.total, currency)}
                </TableCell>
                <TableCell className="text-right">
                  <DropdownMenu>
