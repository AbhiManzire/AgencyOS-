...
interface LineItemDrawerProps {
  ...
  readonly lineItem?: QuoteLineItemListItem;
            ...
            <div className="space-y-6 pb-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label htmlFor="line-item-name" className="text-sm font-medium">
                    Name
                  </label>
                  <Input
                    id="line-item-name"
                ...
                <div className="space-y-2">
                  <label htmlFor="line-item-description" className="text-sm font-medium">
                    Description
                  </label>
                  <Input
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <label htmlFor="line-item-quantity" className="text-sm font-medium">
                      Quantity
                    </label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <label htmlFor="line-item-unit" className="text-sm font-medium">
                      Unit
                    </label>
                    <Input
                      id="line-item-unit"
                ...
                <div className="space-y-2">
                  <label htmlFor="line-item-unit-price" className="text-sm font-medium">
                    Unit Price
                  </label>
                  <Input
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <label htmlFor="line-item-discount" className="text-sm font-medium">
                      Discount
                    </label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <label htmlFor="line-item-tax" className="text-sm font-medium">
                      Tax
                    </label>
                    <Input
                      id="line-item-tax"
                ...
                <div className="rounded-lg border border-border bg-muted/40 p-4">
                  ...
                  <p className="text-lg font-semibold">
                    {formatQuoteAmount(previewTotal, currency)}
                  </p>
                </div>
              </div>
            </div>
