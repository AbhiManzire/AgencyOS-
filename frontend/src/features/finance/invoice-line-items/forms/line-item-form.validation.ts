...
export function lineItemToFormValues(item: InvoiceLineItemListItem): LineItemFormValues {
  return {
    name: item.name,
...
export function toCreateLineItemPayload(values: LineItemFormValues): CreateInvoiceLineItemPayload {
  return {
...
export function toUpdateLineItemPayload(values: LineItemFormValues): UpdateInvoiceLineItemPayload {
