            ...
            {lineItems.map((item, index) => (
              <TableRow key={item.id}>
                ...
                <TableCell className="text-right">
                  {formatInvoiceAmount(item.unitPrice, currency)}
                </TableCell>
                <TableCell className="hidden sm:table-cell text-right">
                  {formatInvoiceAmount(item.discount, currency)}
                </TableCell>
                <TableCell className="hidden sm:table-cell text-right">
                  {formatInvoiceAmount(item.tax, currency)}
                </TableCell>
                <TableCell className="text-right font-medium">
                  {formatInvoiceAmount(item.total, currency)}
                </TableCell>
                <TableCell className="text-right">
                  <DropdownMenu>
